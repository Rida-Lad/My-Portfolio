...
const ContactSection = forwardRef((props, ref) => {
  ...
  return (
    <section ref={ref} id="contact" className="bg-black text-white min-h-screen flex flex-col justify-between py-20 px-6 md:px-12 relative overflow-hidden">
      {/* Red glow effect */}
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10 text-center flex-1 flex flex-col justify-center">
        ...
        <div className="flex flex-wrap justify-center gap-12 md:gap-24 mt-16">
          ...
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=ridlad7@gmail.com" className="text-red-300 hover:text-red-400 transition-colors" target="_blank" rel="noopener noreferrer">
