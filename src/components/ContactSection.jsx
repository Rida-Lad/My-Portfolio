    ...
    <section className="bg-black text-white min-h-screen flex items-center py-20 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-12 md:gap-24 mt-16">
          <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-400 transition-colors">
            <FaGithub className="w-16 h-16" />
          </a>
          
          <a href="https://linkedin.com/in/yourprofile" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-400 transition-colors">
            <FaLinkedin className="w-16 h-16" />
          </a>
          
          <a href="mailto:your.email@gmail.com" className="text-red-500 hover:text-red-400 transition-colors">
            <SiGmail className="w-16 h-16" />
          </a>
          
          <a href="https://wa.me/yourphonenumber" target="_blank" rel="noopener noreferrer" className="text-red-500 hover:text-red-400 transition-colors">
