...
const ProjectCard = ({ project }) => {
    ...
    // Use useMemo to optimize the tech stack rendering
    ...
    return (
        ...
        >
            {/* Animated gradient background - preserving your original animation approach */}
            ...
            <div className="relative h-full bg-black/90 backdrop-blur-sm rounded-2xl p-6">
                {/* Content - memoized rendering for static parts */}
                {useMemo(() => (
                ...
                ), [project.name, project.description, project.github, techStackElements])}
            </div>
